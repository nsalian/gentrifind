...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        descriptionButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent transition = new Intent(v.getContext(), Description.class);
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            averagePrice.setJustificationMode(Layout.JUSTIFICATION_MODE_INTER_WORD);
        }
        modifiedPrice = findViewById(R.id.modifiedPrice);
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            modifiedPrice.setJustificationMode(Layout.JUSTIFICATION_MODE_INTER_WORD);
        }
